...
class _UnlockScreenState extends State<UnlockScreen>
  ...
  final bool _hasPromptedBiometrics = false;
  ...
  Widget _buildStateContent(BuildContext context, AuthState state) {
    ...
    if (state is AuthSetupRequired) {
      return _buildGlassCard(child: _buildSetupForm(context));
    }
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          padding: padding,
          decoration: BoxDecoration(
            color: Colors.white.withOpacity(0.03), // More transparent
            borderRadius: BorderRadius.circular(24),
            border: Border.all(
  ...
  Widget _buildSetupForm(BuildContext context) {
    return Column(
      ...
      children: [
            const Icon(Icons.shield_outlined, size: 48, color: Color(0xFF818CF8)),
            ...
            Text(
              'Set a strong passphrase to secure your local data.',
